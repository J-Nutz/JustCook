...
{
    private static src.main.java.com.jnutz.jooq.public_.tables.RecipeIngredients RECIPE_INGREDIENTS = new src.main.java.com.jnutz.jooq.public_.tables.RecipeIngredients();
    ...
    public static boolean addRecipeIngredient(RecipeIngredient recipeIngredient)
    {
        ...
        {
            return database.insertInto(RECIPE_INGREDIENTS, RECIPE_INGREDIENTS.ID, RECIPE_INGREDIENTS.INDEX,
                                       RECIPE_INGREDIENTS.INGREDIENT_ID, RECIPE_INGREDIENTS.AMOUNT_NEEDED)
                           .values(recipeIngredient.getId(), recipeIngredient.getIndex(),
                                   recipeIngredient.getIngredientId(), recipeIngredient.getAmountNeeded())
                           .execute() == 1;
        }
