...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = -811088847;
     ...
     */
    public final TableField<UsersRecord, Short> ID = createField(DSL.name("ID"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false).identity(true), this, "");
