...
public class CookbooksRecord extends UpdatableRecordImpl<CookbooksRecord> implements Record3<Short, String, Short>
{
    ...
    private static final long serialVersionUID = -1447893189;
    ...
    /**
     * Setter for <code>PUBLIC.Cookbooks.Recipes_Index</code>.
     */
    public void setRecipesIndex(Short value)
    {
        set(2, value);
    }
    
    /**
     * Getter for <code>PUBLIC.Cookbooks.Recipes_Index</code>.
     */
    public Short getRecipesIndex()
    {
        return (Short) get(2);
    }
    ...
    {
        return Cookbooks.COOKBOOKS.RECIPES_INDEX;
    }
     ...
     */
    public CookbooksRecord(Short id, String name, Short recipesIndex)
    {
        super(Cookbooks.COOKBOOKS);
