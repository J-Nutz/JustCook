...
public class Cookbooks extends TableImpl<CookbooksRecord>
{
    ...
    private static final long serialVersionUID = -2104216760;
     ...
     */
    public final TableField<CookbooksRecord, Short> ID = createField(DSL.name("Id"),
     ...
     */
    public final TableField<CookbooksRecord, String> NAME = createField(DSL.name("Name"),
                                                                        org.jooq.impl.SQLDataType.VARCHAR(32), this,
                                                                        "");
    
    /**
     * The column <code>PUBLIC.Cookbooks.Recipes_Id</code>.
     */
    public final TableField<CookbooksRecord, Short> RECIPES_ID = createField(DSL.name("Recipes_Id"),
