...
public class Employees extends TableImpl<EmployeesRecord>
{
     ...
     */
    public final TableField<EmployeesRecord, Short> USERID = createField(DSL.name("UserId"),
     ...
     */
    public final TableField<EmployeesRecord, String> FIRSTNAME = createField(DSL.name("FirstName"),
     ...
     */
    public final TableField<EmployeesRecord, String> LASTNAME = createField(DSL.name("LastName"),
     ...
     */
    public final TableField<EmployeesRecord, Byte> AGE = createField(DSL.name("Age"), org.jooq.impl.SQLDataType.TINYINT,
                                                                     this, "");
    
    /**
     * The column <code>PUBLIC.Employees.DateOfBirth</code>.
     */
    public final TableField<EmployeesRecord, Date> DATEOFBIRTH = createField(DSL.name("DateOfBirth"),
                                                                             org.jooq.impl.SQLDataType.DATE, this, "");
    
    /**
     * The column <code>PUBLIC.Employees.Email</code>.
     */
    public final TableField<EmployeesRecord, String> EMAIL = createField(DSL.name("Email"),
                                                                         org.jooq.impl.SQLDataType.VARCHAR(254), this,
                                                                         "");
